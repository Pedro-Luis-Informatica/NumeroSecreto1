...
if (numeroTreinta == stringTreinta) {
  console.log(
    "Las variables numeroTreinta y stringTreinta tienen el mismo valor, pero tipos diferentes"
  );
} else {
  console.log(
    "Las variables numeroTreinta y stringTreinta no tienen el mismo valor"
  );
}
